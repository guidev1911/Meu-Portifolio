        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="animate-fade-in-up">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Olá, eu sou
              <span className="block text-blue-400 mt-2">João Silva</span>
            </h1>

            <div className="text-2xl md:text-3xl text-gray-300 mb-8 h-12">
              <span className="border-r-2 border-blue-400 animate-blink">{text}</span>
            </div>

            <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              Especialista em desenvolvimento de aplicações robustas e escaláveis usando Java, Spring Boot, microserviços
              e tecnologias modernas de backend.
            </p>
